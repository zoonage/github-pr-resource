...
| `paths`                     | No       | `["terraform/*/*.tf"]`           | Only produce new versions if the PR includes changes to files that match one or more patterns (following the syntax of [filepath.Match](https://pkg.go.dev/path/filepath#Match) or prefixes.                                                                                               |
| `path_regexps`              | No       | `["^terraform/.*\.tf$"]`         | Only produce new versions if the PR includes changes to files that match one or more regexps (following the syntax of [re2](https://github.com/google/re2/wiki/Syntax).                                                                                                                    |
